...
import net.zgraph.chart.BarChart;
import net.zgraph.chart.BubbleChart;
import net.zgraph.chart.CombinedXYChart;
import net.zgraph.chart.CubicLineChart;
import net.zgraph.chart.DialChart;
import net.zgraph.chart.DoughnutChart;
import net.zgraph.chart.LineChart;
import net.zgraph.chart.PieChart;
import net.zgraph.chart.RangeBarChart;
import net.zgraph.chart.ScatterChart;
import net.zgraph.chart.TimeChart;
import net.zgraph.chart.XYChart;
import net.zgraph.chart.BarChart.Type;
import net.zgraph.model.CategorySeries;
import net.zgraph.model.MultipleCategorySeries;
import net.zgraph.model.XYMultipleSeriesDataset;
import net.zgraph.renderer.DefaultRenderer;
import net.zgraph.renderer.DialRenderer;
import net.zgraph.renderer.XYMultipleSeriesRenderer;
